...
SequenceUnion *getSequenceUnion (Int64 num, Int64 numOfSubjects, Int64 numOfQueries) { 
  SequenceUnion *seqUnion = NULL;
	...
	seqUnion = (SequenceUnion *)/*e*/malloc(sizeof(SequenceUnion));
	seqUnion->numOfSubjects = numOfSubjects;

	seqUnion->numOfQueries = numOfQueries;

	//seqUnion->seqBorders = (Int64 *)/*e*/malloc(sizeof(Int64) * (size_t)(seqUnion->numOfSubjects + 1));
	//seqUnion->bordersWithinSeq = (Int64 **)/*e*/malloc(sizeof(Int64 *) * (size_t)(seqUnion->numOfSubjects + 1));
	seqUnion->seqBorders = (Int64 *)/*e*/malloc(sizeof(Int64) * (size_t)num);
	seqUnion->bordersWithinSeq = (Int64 **)/*e*/malloc(sizeof(Int64 *) * (size_t)num);
	seqUnion->gc = /*e*/malloc(sizeof(double) * (size_t)num);
	return seqUnion;
}
