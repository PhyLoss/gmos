...
/* libdivsufsort, Y. Mori 2010 */
#ifdef VER32
Int64 *getSuffixArray2(Sequence *seq){
  //Int64 overshoot;
  Int64 *sa = NULL;
  UChar *textu = NULL;
  
  sa = (Int64 *)/*e*/malloc((size_t)(seq->len + 1) * sizeof(Int64));
  textu = (UChar *)seq->seq;
  divsufsort(textu, (sa + 1), seq->len);
...
#ifndef VER32 // VER64
// deep-shallow SA (Manzini and Ferragina)
