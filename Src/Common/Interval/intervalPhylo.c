...
Interval *getIntervalPhylo(Int64 lcp, Int64 lb, Int64 rb, Interval *child, Int64 numOfSubjects, Interval *parent, Int64 maxDepth, int maxChildren){
  ...
  interval->children = (Interval **)/*e*/malloc(interval->maxNumChildren * sizeof(Interval *));
	...
	/* subjects */
	interval->subjectIndex = (int *)/*e*/malloc(sizeof(int) * numOfSubjects);
	//interval->subjectIndex = (short *)/*e*/malloc(sizeof(short) * numOfSubjects);
